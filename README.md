...
## 📖 Perfil Profesional
Profesional con experiencia en soporte técnico, gestión documental y administración de plataformas TI.  
Especialista en mantenimiento preventivo y correctivo de equipos, supervisión de sistemas de CCTV y atención a usuarios.  
Trayectoria en entornos corporativos y bancarios, aplicando normas **ISO** y buenas prácticas de **ciberseguridad**.  
Con conocimientos básicos en **SAP** para gestión documental y procesos.  

---

## 💼 Experiencia Laboral

### Supervisor de Proyectos – **Filestorage S.A.**  
📅 Ago 2025 – Ene 2026  
...
### Help Desk 1 – **Filestorage S.A.**  
📅 Ene 2025 – Jul 2025  
- Mantenimiento preventivo y correctivo de equipos informáticos y redes.  
- Resolución de incidencias y soporte a usuarios.  
- Monitoreo de servidores físicos y virtuales.  
- Supervisión de sistemas de CCTV.  
- Administración de plataforma educativa **Moodle**.  

### Líder de Proyecto – **Consorcio MEB**  
📅 Oct 2024 – Ene 2025  
- Coordinación de digitalización documental para ARCA Ecuador.  
- Manejo de gestores documentales: **OnBase, SharePoint**.  
- Supervisión de equipos de escaneo y archivo digital.  
- Producción de informes y presentaciones a la dirección.  

### Supervisor de Proyectos – **Filestorage S.A.**  
📅 Ene 2018 – Dic 2024  
- Coordinación de proyectos de digitalización documental.  
- Supervisión de equipos y control de calidad.  
- Elaboración de informes de avance y reportes mensuales.  

### Indexador – **Seventeenmile S.A.**  
📅 Mar 2013 – Dic 2017  
- Gestión documental y digitalización.  
- Control de calidad en procesos de indexación.  
...
- Auditor Interno ISO 27001:2022 – CVS S.A.  
- Fundamentos Auditor ISO 27001:2022 – Hacker Mentor  
- Ley de Protección de Datos Personales e ISO 27001 – Progenios  
- CNNA Introducción a las Redes – Cisco  
- Transformación Digital y IoT – Academia Cisco  
- Introducción a la Ciberseguridad – Academia Cisco  
- Power BI – Daxus Latam  
- Uso Seguro de Medios Informáticos – Academia ESET  
- Introducción al Desarrollo con IA – ITSQMET  
- Gestión Documental – Instituto Santafé  
